...
import com.ar.test.constants.ARTestConstants;
import com.ar.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ARTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ARtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ARtest/import/reviews.impex");
			...
			importImpexFile(context, "/ARtest/import/cstickets.impex");
		}
	}
}
