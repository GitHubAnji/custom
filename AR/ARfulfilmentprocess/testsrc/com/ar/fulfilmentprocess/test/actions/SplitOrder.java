 ...
 */
package com.ar.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ARFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ARFulfilmentProcessConstants.PARENT_PROCESS);
