...
import com.ar.cockpits.constants.ARCockpitsConstants;
 ...
 */
@SystemSetup(extension = ARCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ARCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ARCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ARCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/ARcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
