 ...
 */
package com.ar.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('ARstorefront.generic.cms.component.controller.authorized.group')}")
