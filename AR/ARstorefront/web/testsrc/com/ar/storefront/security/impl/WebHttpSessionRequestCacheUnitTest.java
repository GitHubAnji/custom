...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ARstorefront/electronics/en",
						"https://electronics.local:9002/ARstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ARstorefront/electronics/en",
						"https://electronics.local:9002/ARstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ARstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ARstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ARstorefront/electronics/en",
						"https://electronics.local:9002/ARstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ARstorefront",
						"https://electronics.local:9002/ARstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ARstorefront",
						"https://electronics.local:9002/ARstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ARstorefront/electronics/en",
						"https://electronics.local:9002/ARstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
